...
func (suite *IntegrationTestSuite) TestTextModule() {
	...
	suite.Run("Text analysis", func() {
		...
		body, _ := json.Marshal(payload)
		w := httptest.NewRecorder()
		req, _ := http.NewRequest("POST", "/api/v1/text/info", bytes.NewBuffer(body))
		req.Header.Set("Content-Type", "application/json")
		suite.router.ServeHTTP(w, req)
...
func (suite *IntegrationTestSuite) TestTransformModule() {
	...
	suite.Run("URL encoding/decoding", func() {
		...
		body, _ := json.Marshal(encodePayload)
		w := httptest.NewRecorder()
		req, _ := http.NewRequest("POST", "/api/v1/transform/url", bytes.NewBuffer(body))
		req.Header.Set("Content-Type", "application/json")
		suite.router.ServeHTTP(w, req)
	...
	suite.Run("JWT decoding", func() {
		...
		body, _ := json.Marshal(payload)
		w := httptest.NewRecorder()
		req, _ := http.NewRequest("POST", "/api/v1/transform/jwt/decode", bytes.NewBuffer(body))
		req.Header.Set("Content-Type", "application/json")
		suite.router.ServeHTTP(w, req)
...
func (suite *IntegrationTestSuite) TestIDModule() {
	suite.Run("UUID generation", func() {
		...
		for _, tt := range tests {
			suite.Run(tt.name, func() {
				...
				body, _ := json.Marshal(payload)
				w := httptest.NewRecorder()
				req, _ := http.NewRequest("POST", "/api/v1/id/uuid", bytes.NewBuffer(body))
				req.Header.Set("Content-Type", "application/json")
				suite.router.ServeHTTP(w, req)
	...
	suite.Run("Nano ID generation", func() {
		...
		body, _ := json.Marshal(payload)
		w := httptest.NewRecorder()
		req, _ := http.NewRequest("POST", "/api/v1/id/nanoid", bytes.NewBuffer(body))
		req.Header.Set("Content-Type", "application/json")
		suite.router.ServeHTTP(w, req)
...
func (suite *IntegrationTestSuite) TestTimeModule() {
	suite.Run("Current time", func() {
		w := httptest.NewRecorder()
		req, _ := http.NewRequest("GET", "/api/v1/time/now", nil)
		suite.router.ServeHTTP(w, req)
...
func (suite *IntegrationTestSuite) TestNetworkModule() {
	suite.Run("URL parsing", func() {
		...
		body, _ := json.Marshal(payload)
		w := httptest.NewRecorder()
		req, _ := http.NewRequest("POST", "/api/v1/web/url", bytes.NewBuffer(body))
		req.Header.Set("Content-Type", "application/json")
		suite.router.ServeHTTP(w, req)
	...
	suite.Run("IP analysis", func() {
		...
		for _, tt := range tests {
			suite.Run(tt.name, func() {
				...
				body, _ := json.Marshal(payload)
				w := httptest.NewRecorder()
				req, _ := http.NewRequest("POST", "/api/v1/network/ip", bytes.NewBuffer(body))
				req.Header.Set("Content-Type", "application/json")
				suite.router.ServeHTTP(w, req)
...
func (suite *IntegrationTestSuite) TestErrorHandling() {
	...
	suite.Run("405 Method Not Allowed", func() {
		w := httptest.NewRecorder()
		req, _ := http.NewRequest("PUT", "/health", nil)
		suite.router.ServeHTTP(w, req)
	...
	suite.Run("400 Bad Request - Invalid JSON", func() {
		w := httptest.NewRecorder()
		req, _ := http.NewRequest("POST", "/api/v1/crypto/hash", bytes.NewBufferString("invalid json"))
		req.Header.Set("Content-Type", "application/json")
		suite.router.ServeHTTP(w, req)
