...
type CaseConvertRequest struct {
	...
	CaseType string `json:"caseType" binding:"required,oneof=UPPERCASE lowercase 'Title Case' 'Sentence case' camelCase PascalCase snake_case kebab-case"` //nolint:lll
}
